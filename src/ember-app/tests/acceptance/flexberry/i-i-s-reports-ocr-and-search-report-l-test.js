...
moduleForAcceptance('[AGAT] Acceptance | i i s reports ocr and search report l');

test('testing i-i-s-reports-ocr-and-search-report-l', function(assert) {
  visit('/i-i-s-reports-ocr-and-search-report-l');
